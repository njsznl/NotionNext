...
const BLOG = {
  AUTHOR: 'njsznl', // 作者
  BIO: '新时代农民工 & 干饭人🍚', // 作者简介
  LINK: 'https://notion.njsznl.cn', // 网站地址
  ...
  CONTACT_EMAIL: 'yilaokela@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/njsznl',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'myrepo', // 你的Github仓库名，例如 'NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'YI\'S BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '该睡觉了。。', // 站点描述，被notion中的页面描述覆盖
